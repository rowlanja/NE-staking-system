...
contract Items is ERC1155, Ownable, ReentrancyGuard, AccessControl {
    ...
    uint256 public constant BUY_FEE = 0.05 ether;
    
    mapping(address => bool) public hasClaimed;
    mapping(address => bool) public allowedAddresses;

    uint8 public constant POTION_TOKEN_ID = 0;
    ...
    // function buy() external payable nonReentrant {
        // require(msg.value == BUY_FEE, "Not enough fee");
    function buy() external payable nonReentrant {

        _mint(msg.sender, POTION_TOKEN_ID, 1, "");
